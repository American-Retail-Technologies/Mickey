...
-------------------------------------------------------------------------*/
namespace Sm\ListingExtend\Helper;
use Magento\Framework\Filesystem;
use Magento\Framework\ObjectManagerInterface;
use Magento\Store\Model\StoreManagerInterface;
use Magento\Framework\App\Helper\AbstractHelper;
use Magento\Framework\App\Filesystem\DirectoryList;
use Sm\ListingExtend\Block\ListingExtend;
...
class Data extends AbstractHelper
{
	...
	public function __construct(
		...
		\Sm\ListingExtend\Block\ListingExtend $block
	){
	...
	private function getProductImages($product, $_config, $prefix = 'img')
	{
		...
		$_placeholder = ($placeholder != '' && strpos($placeholder, 'http') !== false) ? $placeholder :  $this->_block->getViewFileUrl('Sm_ListingExtend::images/nophoto.jpg');
