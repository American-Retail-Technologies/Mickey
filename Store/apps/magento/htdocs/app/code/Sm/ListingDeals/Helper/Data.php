...
-------------------------------------------------------------------------*/
namespace Sm\ListingDeals\Helper;
...
class Data extends AbstractHelper
{
	...
	public function __construct(
		\Sm\ListingDeals\Block\ListingDeals $block,
	...
	private function getProductImages($product, $_config, $prefix = 'img')
	{
		...
		$_placeholder = ($placeholder != '' && strpos($placeholder, 'http') !== false) ? $placeholder :  $this->_block->getViewFileUrl('Sm_ListingDeals::images/nophoto.jpg');
