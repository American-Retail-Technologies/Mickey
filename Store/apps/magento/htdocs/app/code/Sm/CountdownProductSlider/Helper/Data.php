...
-------------------------------------------------------------------------*/
namespace Sm\CountdownProductSlider\Helper;
use Magento\Framework\Filesystem;
use Magento\Framework\ObjectManagerInterface;
use Magento\Store\Model\StoreManagerInterface;
use Magento\Framework\App\Helper\AbstractHelper;
use Magento\Framework\App\Filesystem\DirectoryList;
use Sm\CountdownProductSlider\Block\CountdownProductSlider;
...
class Data extends AbstractHelper
{
	...
	public function __construct(
		...
		\Sm\CountdownProductSlider\Block\CountdownProductSlider $block
	){
	...
	private function getProductImages($product, $_config, $prefix = 'img')
	{
		...
		$_placeholder = ($placeholder != '' && strpos($placeholder, 'http') !== false) ? $placeholder :  $this->_block->getViewFileUrl('Sm_CountdownProductSlider::images/nophoto.jpg');
