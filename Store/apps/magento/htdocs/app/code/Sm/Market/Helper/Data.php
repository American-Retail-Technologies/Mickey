...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function getUrlStatic(){
        //2018-02-19 TK: Replace http to https if use_secure_frontend is set
		$url_static = $this->_storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_STATIC);
        //$url_static = str_replace('http://', 'https://', $url_static);
