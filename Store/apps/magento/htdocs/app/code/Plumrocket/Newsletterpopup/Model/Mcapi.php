...
class Mcapi
{
     ...
     */
    function campaigns($filters = [], $start = 0, $limit = 25, $sort_field = 'create_time', $sort_dir = 'DESC')
    {
        $params = [];
     ...
     */
    function lists($filters = [], $start = 0, $limit = 25, $sort_field = 'created', $sort_dir = 'DESC')
    {
        $params = [];
        $params["filters"] = $filters;
        $params["start"] = $start;
     ...
     */
    function getAccountDetails($exclude = [])
    {
        $params = [];
