...
namespace Sm\ShopBy\Helper;

use Magento\Framework\ObjectManagerInterface;
use Magento\Store\Model\StoreManagerInterface;
use Magento\Framework\App\Helper\AbstractHelper;
use Magento\Framework\App\Filesystem\DirectoryList;
use Sm\ShopBy\Block\Catalog\Product\Pager;
...
class Data extends AbstractHelper
{
	...
	public function __construct(
		...
		\Sm\ShopBy\Block\Catalog\Product\Pager $block
	){
	...
	private function getProductImages($product, $_config, $prefix = 'img')
	{
		...
		$_placeholder = ($placeholder != '' && strpos($placeholder, 'http') !== false) ? $placeholder :  $this->_block->getViewFileUrl('Sm_ShopBy::images/nophoto.jpg');
