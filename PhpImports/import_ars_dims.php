...
if ($_FILES['csv']['size'] > 0) { 
    ...
    //redirect 
    header('Location: import_ars_dims.php?success=1&row_strings='.$row_strings); die; 
...
<title>Import ars_dims Option Values</title> 
</head> 
...
<h2>Import ars_dims Option Values</h2>
