...
if ($_FILES['csv']['size'] > 0) { 
    ...
    //redirect 
    header('Location: import_ars_material.php?success=1&row_strings='.$row_strings); die; 
...
<title>Import ars_material Option Values</title> 
</head> 
...
<h2>Import ars_material Option Values</h2>
